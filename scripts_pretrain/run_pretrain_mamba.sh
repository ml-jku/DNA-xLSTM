...
# Pretrain Mamba
# See all model parameters in configs/model/mamba.yaml
...
WANDB_NAME="mamba_bidir-false_rcaug-${RC_AUG}_seqlen-${SEQLEN_DIS}_dmodel-${D_MODEL}_nlayer-${N_LAYER}_lr-${LR}_runid-${TIMESTAMP}"
